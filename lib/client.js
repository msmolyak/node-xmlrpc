...
function Client(options, isSecure) {
  ...
  options.method = 'POST'
  if (options.tor) {
    options.socksHost = options.socksHost || 'localhost'
    options.socksPort = options.socksPort || 9050
  }
...
Client.prototype.methodCall = function methodCall(method, params, callback) {
  ...
  var transport = this.options.tor ? (this.isSecure ? shttps : shttp) : (this.isSecure ? https : http)
